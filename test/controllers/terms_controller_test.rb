...
class TermsControllerTest < ActionController::TestCase
  ...
  test "should create term" do
    assert_difference('Term.count') do
      post :create, term: { definition: @term.definition, example: @term.example, phrase: @term.phrase }
    end
  ...
  test "should update term" do
    patch :update, id: @term, term: { definition: @term.definition, example: @term.example, phrase: @term.phrase }
    assert_redirected_to term_path(assigns(:term))
  end
